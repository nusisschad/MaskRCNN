...
# Requires TensorFlow 1.14+ and Keras 2.2.4+.
...
class MaskRCNN():
	...
	###################
	# Chad modified
        self.checkpoint_path = os.path.join(self.log_dir, "mask_rcnn_{}_new.h5".format(self.config.NAME.lower()))
	###################
...
# To use it, create a  new config class and inherit from this.
####################################################################################
